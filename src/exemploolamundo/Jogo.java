...
public class Jogo {
    ...
    private static final char PAREDV = '|';
    private static final char PAREDEH = '-';
    private static final char TAMANHO = 10;
    private static final char VAZIO = ' ';
    private static char[][]tabuleiro;
    
    private static final char INICIO = 'C';
 ...
 public static void inicializarMatriz(){
     int i,j;
      for (i=0;i < TAMANHO;i++){
          tabuleiro[i][0]= PAREDV;
          tabuleiro[i][TAMANHO -1]= PAREDV;
          tabuleiro[0][i]=PAREDEH;
          tabuleiro[TAMANHO -1][i]=PAREDEH;        
    }
  ...
  int valor = (int)Math.round(Math.random()*(maximo-minimo)); // funcao q vai gerar um numero aleatorio 
  return valor + minimo;
  }
